...
import my_models.deit_orig as deit_with_classifier
...
#    std = IMAGENET_DEFAULT_STD
    ...
    model = deit_with_classifier.__dict__['deit_small_patch16_LS'](pretrained=True, pretrained_21k = True)
    # print("*************pretrained msn imgnet model")
    print("********************************orig deit")
    
    model = interpolate_pos_embed(model, new_size=672)
    # TODO: finetuning
