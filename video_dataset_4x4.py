...
class VideoDataSet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # alternate_images = images[::2]
        # print("type(alternate_images):",type(alternate_images))
        # print("len(alternate_images):",len(alternate_images))
        # print("alternate_images[0].size:",alternate_images[0].size)
        # print("type(alternate_images[0]):",type(alternate_images[0]))
        # for i, img in enumerate(images):
        #     img.save(f"image_{i:02d}.png")
        # for i, img in enumerate(alternate_images):
        #     img.save(f"alternate_images_{i:02d}.png")
        ...
        if self.temporal_aug:
            ...
            #     img.save(f"selected_images_{i:02d}.png")
            img_views += [self.focal_transform(selected_images) for i in range(self.focal_views)]
            # exit(0)
        else:
            img_views += [self.focal_transform(images) for i in range(self.focal_views)]
        
        # print("len(img_views):",len(img_views))
        # print("img_views[2].size():",img_views[2].size())
