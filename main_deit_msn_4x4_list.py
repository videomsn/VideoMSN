...
def main(args):
    ...
    print(type(args.fviews))
    print(type(args.rviews))
...
#    std = IMAGENET_DEFAULT_STD
    ...
    train_rand_transform = get_augmentor(True, args.rand_size, mean, std, threed_data=args.threed_data,version=args.augmentor_ver, scale_range=args.scale_range, dataset=args.dataset, scales=args.rviews) #scales=[1, 0.875, .75, .66]) 
    train_focal_transform = get_augmentor(True, args.focal_size, mean, std, threed_data=args.threed_data,version=args.augmentor_ver, scale_range=args.scale_range, dataset=args.dataset, scales=args.fviews) #scales=[0.3, .2625, .225, .198])  
    exit(0)
