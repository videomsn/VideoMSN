...
DATASET_CONFIG = {
    ...
    'kinetics400': {
        'num_classes': 400,
        #'train_list_name': 'train_dgx001.txt',
        # 'train_list_name': 'one_video.txt',
        # 'train_list_name': 'k400_1per.txt',
        # 'train_list_name': 'k400_10per.txt',
        'train_list_name': 'train_25percent_dgx001.txt',
        'val_list_name': 'val_dgx001.txt',
        'test_list_name': 'val_dgx001.txt',
        'filename_seperator': " ",
        'image_tmpl': '{:05d}.jpg',
        'filter_video': 30,
